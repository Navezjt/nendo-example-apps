...
cd nendo-example-apps/polymath
...
```bash
python main.py -a https://www.youtube.com/watch\?v\=OPf0YbXqDm0 -q 110 -e "./results"
```
...
The full audio processing in this example takes up about 60 lines of code to do MIR, stemification, quantization, loopification and finally, exporting of processed samples.
